...
b) dataCollection.py - this script is used to collect photos of our gestures with webcam.
c) test.py - this script is main of project. We declare there which model of neural network we want to use and with webcam this program recognize our gestures.
d) Model folder - in this folder is neural network model, which we will using in recognition.
